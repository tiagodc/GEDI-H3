if __name__ == "__main__":
    ...
    from gedih3.gh3builder import h3_merge_metadata, h3_write_metadata
    ...
    def join_gh3_files(src_path):
        try:
            ...
            parquet_join_columns(
                flist=flist, ofile=out_path, key_col="shot_number", tmp_suffix=".join.tmp", join_how="left"
            )

            mfile = h3_write_metadata(out_path)  # noqa: F841
            return out_path
