...
| Variable update workers (scan + per-granule fan-out + per-(cell, year) sidecar merge) | `gh3builder.py:_scan_year_file_for_update`, `_write_granule_var_fragment`, `_merge_year_sidecar` | `test_build_safety.py::TestAddVariablesResume` |
