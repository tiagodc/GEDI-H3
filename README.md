...
gh3_build_ducklake
## Optionally build the bbox index (skips files spatial queries cannot touch)
gh3_bbox_index
...
| `gh3_bbox_index` | Build the data-bbox index so spatial queries skip untouched files |
